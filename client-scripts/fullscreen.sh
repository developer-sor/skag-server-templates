...
sleep 15 && sudo -u pi chromium-browser -kiosk --args --disable-web-security --disable-session-crashed-bubble --test-type --user-data-dir=file:///home/pi/repo/ file:///home/pi/repo/index.html?forceFetch=true >>/home/pi/ep-log.txt 2>&1 &
sleep 20
