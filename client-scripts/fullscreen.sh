...
sleep 15 && sudo -u pi chromium-browser -kiosk --args --disable-web-security --disable-translate --disable-infobars --disable-session-crashed-bubble --user-data-dir=file:///home/pi/ --test-type file:///home/pi/repo/index.html?forceFetch=true >>/home/pi/ep-log.txt 2>&1 &
sleep 20
