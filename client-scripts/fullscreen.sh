...
#--disable-infobars
sleep 15 && sudo -u pi chromium-browser -kiosk --disable-web-security --restore-last-session --disable-infobars --disable-translate --user-data-dir=file:///home/pi/ file:///home/pi/repo/index.html?forceFetch=true >>/home/pi/ep-log.txt 2>&1 &
sleep 20
